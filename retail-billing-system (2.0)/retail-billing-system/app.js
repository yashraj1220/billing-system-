...
async function loadProductDropdowns() {
    ...
    // Show alert if no products
    if (products.length === 0 && document.getElementById('new-invoice').classList.contains('active')) {
        showAlert('No products found! Please add products first before creating an invoice.', 'warning');
    }
}
